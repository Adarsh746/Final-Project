...
class ShoppingProductController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('shopping_products.shopping_pro_franchise_id',$user_id)
        ...
        return view('franchise.view_shopping_product', compact('sh_pro'));
    ...
    public function create()
    {
        ...
        return view('franchise.add_shopping_product', compact('sub_cat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'shopping_sub_cat_id' => 'required',           
                ...
                $sh_pro ->shopping_pro_franchise_id  = $user_id;
            ...
            // return view('table');
             return redirect()->route('franchise.shoppro.index')->with('success','New Product Added');
    }
    ...
    public function edit($id)
    {
        ...
        return view('franchise.edit_shopping_product', compact('sub_cat','fran'));
    }
