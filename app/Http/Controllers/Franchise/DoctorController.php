<?php
    ...
    ->get();
            ...
            return view('franchise.view_doctor', compact('doctor'));
             }
       ...
       ->get();
        ...
        return view('franchise.add_doctor', compact('hospital'));
      }
        ...
        public function store(Request $request)
        {
         ...
         if ($request['image']) {
            ...
            //  ]);
              ...
              // return view('table');
            return redirect()->route('franchise.doctor.index')->with('success','Registration Success');
    ...
    $hospital = hospital::select('hospital_id','hospital_name')
       ...
       ->get();
        ...
        return view('franchise.edit_doctor', compact('hospital','doctor'));
        ...
        public function change(Request $request, $id)
        {
         ...
         if ($request['image']) {
            ...
            //  ]);
              ...
              // return view('table');
            return redirect()->route('franchise.doctor.index')->with('success','Updated');
        ...
        public function destroy($id)
        {
            ...
            return redirect()->route('franchise.doctor.index')->with('success','deleted');
        }
    }
