...
class RealEstateController extends Controller
{
    ...
    public function index()
    {
        ...
        ->whereIn('real_estates.city_id',$city_id)
        ...
        return view('franchise.view_realestate', compact('real'));   
         }   
    ...
    public function create()
    {
        ...
        return view('franchise.add_realestate', compact('post','users'));
    }
            ...
            'property_category' => 'required',
                ...
                $real->save();
                 ...
                 if( $typ == 0){
                    ...
                    return redirect()->route('franchise.realestate.show',0)->with('success','New Property Added');

                 }elseif ($typ == 1) {
                     return redirect()->route('franchise.realestate.show',1)->with('success','New Property Added');
                 }else{
                    return redirect()->route('franchise.realestate.show',2)->with('success','New Property Added');
                 }
    ...
    public function destroy($id)
    {
        ...
        $typ = $real[0]->property_category ;
                 if( $typ == 0){
                    ...
                    return redirect()->route('franchise.realestate.show',0)->with('success','deleted');

                 }elseif ($typ == 1) {
                     return redirect()->route('franchise.realestate.show',1)->with('success','deleted');
                 }else{
                    return redirect()->route('franchise.realestate.show',2)->with('success','deleted');
                 }
    }
}
