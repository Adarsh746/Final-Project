<?php
    ...
    ->get();
            ...
            return view('franchise.view_hospital', compact('hospital'));
             }
       ...
       ->get();
        ...
        return view('franchise.add_hospital', compact('user','city'));
      }
         ...
         if ($request['image1']) {
          ...
          if ($request['logo']) {
            ...
            //  ]);
              ...
              // return view('table');
            return redirect()->route('franchise.hospital.index')->with('success','Registration Success');
    ...
    $user =User::select('user_id','user_name')->get();
       ...
       ->get();
        ...
        return view('franchise.edit_hospital', compact('user','city','hospital'));
         ...
         if ($request['image1']) {
          ...
          if ($request['logo']) {
            ...
            base_path() . '/public/hospital/images/', $imageName10
              ...
              // return view('table');
            return redirect()->route('franchise.hospital.index')->with('success','Updated');
        ...
        public function destroy($id)
        {
            ...
            return redirect()->route('franchise.hospital.index')->with('success','deleted');
        }
    }
