...
class MatrimonyController extends Controller
{
    ...
    public function index()
    {
        ...
        ->whereIn('matrimonies.city_id',$city_id)
        ->where('matrimonies.status','=',0)
        ->get();
        

        return view('franchise.view_matrimony', compact('matri'));   
         }   
    ...
    public function create()
    {
        ...
        return view('franchise.add_matrimony', compact('post','users'));
    }
    ...
    {  if ($request['image']) {
        ...
        $this->validate($request, [
            ...
            // return view('table');
             return redirect()->route('franchise.matrimony.index')->with('success','New Entry Added');
    ...
    public function edit($id)
    {
        ...
        return view('franchise.edit_matrimony', compact('post','users','matri'));
    }
    ...
    public function destroy($id)
    {
        ...
        $matri ->status = 1;
        $matri ->save();
        return redirect()->route('franchise.matrimony.index')->with('success','deleted');
    }
}
