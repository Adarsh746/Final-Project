...
->get();
        ...
        return view('franchise.view_shop', compact('shop'));     }
     ...
     if ($request['image1']) {
      ...
      if ($request['logo']) {
        ...
        $this->validate($request, [
          ...
          // return view('table');
        return redirect()->route('franchise.shop.index')->with('success','Registration Success');
...
$user =User::select('user_id','user_name')->get();
   ...
   ->get();
     ...
     if ($request['image1']) {
      ...
      if ($request['logo']) {
        ...
        $this->validate($request, [
          ...
          // return view('table');
        return redirect()->route('franchise.shop.index')->with('success','Updated');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('franchise.shop.index')->with('success','deleted');
    }
}
