...
class RealEstateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.view_realestate', compact('real'));   
         }   
    ...
    public function create()
    {
        ...
        return view('admin.add_realestate', compact('post','users'));
    }
            ...
            'property_category' => 'required',
                ...
                $real->save();
                 ...
                 if( $typ == 0){
                    ...
                    return redirect()->route('admin.realestate.show',0)->with('success','New Property Added');

                 }elseif ($typ == 1) {
                     return redirect()->route('admin.realestate.show',1)->with('success','New Property Added');
                 }else{
                    return redirect()->route('admin.realestate.show',2)->with('success','New Property Added');
                 }
    ...
    public function destroy($id)
    {
        ...
        $typ = $real[0]->property_category ;
                 if( $typ == 0){
                    ...
                    return redirect()->route('admin.realestate.show',0)->with('success','deleted');

                 }elseif ($typ == 1) {
                     return redirect()->route('admin.realestate.show',1)->with('success','deleted');
                 }else{
                    return redirect()->route('admin.realestate.show',2)->with('success','deleted');
                 }
    }
}
