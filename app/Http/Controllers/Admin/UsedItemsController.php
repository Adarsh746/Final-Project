...
class UsedItemsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.view_useditem', compact('real'));   
         }   
    ...
    public function create()
    {
        ...
        return view('admin.add_useditems', compact('post','users','sub_cat'));
    }
        ...
        $this->validate($request, [
           ...
           'item_name' => 'required',
            ...
            'date_of_manufacture' => 'required'
                ...
                return redirect()->route('admin.useditems.index')->with('success','New Item Added');
    ...
    public function edit($id)
    {
        ...
        $users = User::select('user_id','user_name')->get();
        $sub_cat =Shopping_sub_category::select('shopping_sub_cat_id','shopping_sub_cat_name')->get();
        return view('admin.edit_useditems', compact('post','users','sub_cat','used_items'));
    }
        ...
        $this->validate($request, [
           ...
           'item_name' => 'required',
            ...
            'date_of_manufacture' => 'required'
                ...
                return redirect()->route('admin.useditems.index')->with('success','Updated');
    }
    ...
    { 
        ...
        return redirect()->route('admin.useditems.index')->with('success','deleted');
