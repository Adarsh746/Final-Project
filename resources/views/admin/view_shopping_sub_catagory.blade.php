    ...
    <div class="">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Shopping Sub Category</span>
            </div>
            ...
            <div id="sample_editable_1_wrapper" class="dataTables_wrapper no-footer">
                <div class="table-scrollable">
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        <thead>
                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 139px;" aria-sort="ascending" aria-label=" Username : activate to sort column descending">Shopping Sub Category Id</th>
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending">Shopping Sub Category Name</th>
                             <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending">Shopping Category Name</th>
                        ...
                        @foreach($sub_cat as $value)
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"> {{ $value->shopping_sub_cat_id }}</td>
                                 <td>{{ $value->shopping_sub_cat_name }} </td>
                                <td>{{ $value->shopping_cat_name }} </td>
                                <td class="text-center">
                                <a  href="{{route('admin.subcat.edit',$value->shopping_sub_cat_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('admin.subcat.destroy',$value->shopping_sub_cat_id)}}">
                                    {{ csrf_field() }}
