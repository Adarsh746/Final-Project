    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add Shop Details</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('admin.shop.store') }}">
                        {{ csrf_field() }}
                  ...
                  <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('shop_cat_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="shop_cat_name" type="text" class="form-control" name="shop_cat_name" value="{{ old('shop_cat_name') }}" required autofocus>
