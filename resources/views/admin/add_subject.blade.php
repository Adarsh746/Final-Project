        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.subject.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="col-md-6">      
                        <select id="quali_id"  class="form-control" name="quali_id" value="{{ old('quali_id') }}" required autofocus>
