    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add City</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.city.store') }}">
                        ...
                        <div class="col-md-6">      
                        <select id="post_id"  class="form-control" name="post_id" value="{{ old('post_id') }}" required autofocus>
                        @foreach ($post as $dst)
