        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('admin.matrimony.create')}}" class="btn green" >Add New</a>
                    ...
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="text-center">
                                <a  href="{{route('admin.matrimony.edit',$value->mat_reg_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('admin.matrimony.destroy',$value->mat_reg_id)}}">
                                    {{ csrf_field() }}
