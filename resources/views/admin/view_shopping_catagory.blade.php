    ...
    <div class="">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Shopping Category</span>
            </div>
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('admin.catagory.create')}}" class="btn green" >Add New</a>
            ...
            <div id="sample_editable_1_wrapper" class="dataTables_wrapper no-footer">
                <div class="table-scrollable">
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        <thead>
                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 139px;" aria-sort="ascending" aria-label=" Username : activate to sort column descending">Shopping Category Id</th>
                        ...
                        @foreach($cat as $value)
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"> {{ $value->shopping_cat_id }}</td>
                                <td>{{ $value->shopping_cat_name }} </td>
                                 <td class="text-center">
                                <a  href="{{route('admin.catagory.edit',$value->shopping_cat_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('admin.catagory.destroy',$value->shopping_cat_id)}}">
                                    {{ csrf_field() }}
