    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Edit State</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.state.change',$state->state_id) }}">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('state_name') ? ' has-error' : '' }}">
                            <label for="state_name" class="col-md-4 control-label">State Name</label>
                            <div class="col-md-6">
                                <input id="state_name" type="text" class="form-control" name="state_name" value="{{ $state->state_name }}" required autofocus>
                        ...
                        <div class="col-md-6">      
                        <select id="nation_id"  class="form-control" name="nation_id" value="{{ $state->nation_id }}" required autofocus>
