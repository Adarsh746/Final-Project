    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Edit Shopping Subcategory</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.subcat.change',$sub_cat->shopping_sub_cat_id) }}">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('sub_cat_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sub_cat_name" type="text" class="form-control" name="sub_cat_name" value="{{ $sub_cat->shopping_sub_cat_name }}" required autofocus>
                        ...
                        <div class="col-md-6">      
                        <select id="cat_id"  class="form-control" name="cat_id" value="{{ $sub_cat->shopping_cat_id }}" required autofocus>
