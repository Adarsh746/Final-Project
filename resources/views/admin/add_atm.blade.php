    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add ATM</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.atm.store') }}">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('atm_bank') ? ' has-error' : '' }}">
                            <label for="atm_bank" class="col-md-4 control-label">ATM BANK</label>
                            <div class="col-md-6">
                                <input id="atm_bank" type="text" class="form-control" name="atm_bank" value="{{ old('atm_bank') }}" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('atm_type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="atm_type" type="text" class="form-control" name="atm_type" value="{{ old('atm_type') }}" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('atm_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="atm_address" type="textarea" class="form-control" name="atm_address" value="{{ old('atm_address') }}" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('atm_open_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="atm_open_time" type="time" class="form-control" name="atm_open_time" value="{{ old('atm_open_time') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('atm_close_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="atm_close_time" type="time" class="form-control" name="atm_close_time" value="{{ old('atm_close_time') }}" required autofocus>
