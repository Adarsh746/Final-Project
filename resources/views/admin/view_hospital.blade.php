        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('admin.hospital.create')}}" class="btn green" >Add New</a>
                        ...
                        @foreach($hospital as $value)
                            ...
                            <tr role="row" class="odd">
                               ...
                               <td class="sorting_11"> <img class="dt-img" src="/hospital/images/{{ $value->image1}}"></td>
                                ...
                                <a  href="{{route('admin.hospital.edit',$value->hospital_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('admin.hospital.destroy',$value->hospital_id)}}">
                                    {{ csrf_field() }}
