        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('admin.state.create')}}" class="btn green" >Add New</a>
            ...
            <div id="sample_editable_1_wrapper" class="dataTables_wrapper no-footer">
                <div class="table-scrollable">
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        <thead>
                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 139px;" aria-sort="ascending" aria-label=" state_id : activate to sort column descending"> State id</th>
                        ...
                        @foreach($state as $value)
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"> {{ $value->state_id }}</td>
                                <td>{{ $value->state_name }} </td>
                                <td class="sorting_1"> {{ $value->nation_name }}</td>
                                <td class="text-center">
                                <a  href="{{route('admin.state.edit',$value->state_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('admin.state.destroy',$value->state_id)}}">
                                    {{ csrf_field() }}
