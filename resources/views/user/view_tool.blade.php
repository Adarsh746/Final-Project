    ...
    <div class="">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">My Tools</span>
            </div>
                        ...
                        @foreach($rent as $value)
                            ...
                            <tr role="row" class="odd">
                               ...
                               <td class="sorting_11"> <img class="dt-img" style="max-height:150px; max-width:150px;" src="/tool/images/{{ $value->tool_image}}"></td>
                                ...
                                <a  href="{{route('user.tool.edit',$value->tool_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('user.tool.destroy',$value->tool_id)}}">
                                    {{ csrf_field() }}
