        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="GET" enctype="multipart/form-data" action="{{ route('user.case.change',$case->case_id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control" name="description" value="{{ $case->description }}" required autofocus></textarea>
