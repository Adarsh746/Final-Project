    ...
    <div class="">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Petrol Pumb</span>
            </div>
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('franchise.pumb.create')}}" class="btn green" >Add New</a>
            ...
            <div id="sample_editable_1_wrapper" class="dataTables_wrapper no-footer">
                <div class="table-scrollable">
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        <thead>
                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 139px;" aria-sort="ascending" aria-label="idid : activate to sort column descending">Pumb Id</th>
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" atm_name: activate to sort column ascending">Pumb Name</th>
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" atm_type: activate to sort column ascending">Pumb Company</th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_2" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Address: activate to sort column ascending">Pumb Address</th>
                        ...
                        <tbody>
                        @foreach($pumb as $value)

                            <tr role="row" class="odd">
                                <td class="sorting_1"> {{ $value->pumb_id }}</td>
                                <td class="sorting_1"> {{ $value->pumb_name}}</td>
                                <td class="sorting_1"> {{ $value->pumb_company}}</td>
                                <td class="sorting_1"> {{ $value->place_name}}</td>
                                <td class="sorting_1"> {{ $value->pumb_address}}</td>
                                <td class="sorting_1"> {{ $value->pumb_open_time}}</td>
                                <td class="sorting_1"> {{ $value->pumb_close_time}}</td>
                                <td class="text-center">
                               <a  href="{{route('franchise.pumb.edit',$value->pumb_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('franchise.pumb.destroy',$value->pumb_id)}}">
                                    {{ csrf_field() }}
