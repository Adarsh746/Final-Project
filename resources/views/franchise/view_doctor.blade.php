        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('franchise.doctor.create')}}" class="btn green" >Add New</a>
            ...
            <div id="sample_editable_1_wrapper" class="dataTables_wrapper no-footer">
                <div class="table-scrollable">
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        <thead>
                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 139px;" aria-sort="ascending" aria-label=" state_id : activate to sort column descending"> Doctor id</th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending">Designation</th>
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending">  Hospital Name </th>
                             <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending">  Category </th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending"> Consulting Start Time </th>
                            <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label=" Full Name : activate to sort column ascending"> Consulting End Time </th>
                        ...
                        @foreach($doctor as $value)
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"> {{ $value->doctor_id }}</td>
                                <td class="sorting_2"> <img class="dt-img" src="/doctor/images/{{ $value->image}}"></td>
                               
                                <td class="sorting_1"> {{ $value->doctor_name }}</td>
                                <td class="sorting_1"> {{ $value->designation }}</td>
                                <td class="sorting_1"> {{ $value->hospital_name}}</td>
                                <td class="sorting_1"> {{ $value->doctor_category }}</td>
                                ...
                                <a  href="{{route('franchise.doctor.edit',$value->doctor_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('franchise.doctor.destroy',$value->doctor_id)}}">
                                    {{ csrf_field() }}
