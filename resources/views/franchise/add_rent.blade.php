    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add Tool</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('franchise.rent.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('tool_count') ? ' has-error' : '' }}">
                            ...
                            <label for="rate" class="col-md-4 control-label"> Rent</label>
                            <div class="col-md-6">
