    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add Taxi</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('franchise.taxi.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('taxi_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="taxi_name"  type="text"   class="form-control" name="taxi_name" value="{{ old('taxi_name') }}" autofocus>
                         ...
                         <div class="form-group{{ $errors->has('vehicle_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="vehicle_no" type="text"   class="form-control" name="vehicle_no" value="{{ old('vehicle_no') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('taxi_capacity') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="taxi_capacity" type="text"  required="required"  class="form-control" name="taxi_capacity" value="{{ old('taxi_capacity') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('available_from') ? ' has-error' : '' }}">                    
                            ...
                            <div class="col-md-6">      
                                <Input id="available_from"  class="form-control" name="available_from" type="time" value="{{ old('available_from') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('available_to') ? ' has-error' : '' }}">                    
                            ...
                            <div class="col-md-6">      
                                <Input id="available_to"  class="form-control" name="available_to" type="time" value="{{ old('available_to') }}" required autofocus>
