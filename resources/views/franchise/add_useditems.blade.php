    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add Item</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('franchise.useditems.store') }}">
                        {{ csrf_field() }}
                          <div class="form-group{{ $errors->has('item_name') ? ' has-error' : '' }}">
                            <label for="item_name" class="col-md-4 control-label">Item Name</label>
                            <div class="col-md-6">
                                <input id="item_name"  type="text"   class="form-control" name="item_name" value="{{ old('item_name') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('discription') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('date_of_manufacture') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="date"  id="date_of_manufacture" class="form-control" name="date_of_manufacture" value="{{ old('date_of_manufacture') }}" required autofocus></textarea>
