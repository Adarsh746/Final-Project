...
<html lang="en">
    ...
    <head>
    @include('franchise.includes.head')
      </head>
    <!-- END HEAD -->
    ...
    <div class="modal-body"> 
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="top-menu">
                    @include('franchise.includes.top_nav')
                    </div>
            ...
            <div class="page-container">
                ...
                @include('franchise.includes.side')
                    <!-- END SIDEBAR -->
                </div>
                <!-- END SIDEBAR -->
                <!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        <!-- BEGIN PAGE HEADER-->
                        <!-- BEGIN THEME PANEL -->
                        @include('franchise.includes.theme')
                        <!-- END THEME PANEL -->
                        <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Franchise Profile 
                            <small></small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2016 &copy;Thanuz
                    <a target="_blank" href="http://keenthemes.com">franchise</a> &nbsp;|&nbsp;
...
<![endif]-->
       ...
       @include('franchise.includes.foot')
       @stack('data-tab-foot')
       @stack('data-tab-head')
    </body>
