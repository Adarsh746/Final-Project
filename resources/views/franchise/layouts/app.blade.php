...
<body>
    <div id="app"  style="color:darkslategray">
        <nav class="navbar navbar-default navbar-static-top " style="background-color:#2b3643;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li><a href="{{ route('franchise.login') }}">Login</a></li>
                            <li><a href="{{ route('franchise.register') }}">Register</a></li>
                        @else
                            <li class="dropdown">
