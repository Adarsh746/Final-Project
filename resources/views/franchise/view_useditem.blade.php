    ...
    <div class="">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Used Items</span>
            </div>
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('franchise.useditems.create')}}" class="btn green" >Add New</a>
                    ...
                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="sample_editable_1" role="grid" aria-describedby="sample_editable_1_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1" style="width: 162px;" aria-label="Item Category : activate to sort column ascending">Item Category</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_editable_2" rowspan="1" colspan="1" style="width: 162px;" aria-label="Property Category: activate to sort column ascending">Item Name</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_editable_3" rowspan="1" colspan="1" style="width: 162px;" aria-label="Discription: activate to sort column ascending">Discription</th>
                                 <th class="sorting" tabindex="0" aria-controls="sample_editable_3" rowspan="1" colspan="1" style="width: 162px;" aria-label="Discription: activate to sort column ascending">Manufacture Date</th>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="sorting_4"> {{ $value->shopping_sub_cat_name}}</td>
                            
                            <td class="sorting_3"> {{ $value->item_name}}</td>
                            <td class="sorting_5"> {{ $value->discription}}</td>
                            <td class="sorting_3"> {{ $value->date_of_manufacture}}</td>
                            <td class="sorting_6"> {{ $value->rate}}</td>
                            <td class="sorting_7"> <img class="dt-img" src="/useditems/images/{{ $value->image1}}"></td>
                            <td class="sorting_8"> <img class="dt-img" src="/useditems/images/{{ $value->image2}}"></td>
                            <td class="sorting_9"> <img class="dt-img" src="/useditems/images/{{ $value->image3}}"></td>
                           ...
                           <td class="text-center">
                               <a  href="{{route('franchise.useditems.edit',$value->property_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('franchise.useditems.destroy',$value->property_id)}}">
                                    {{ csrf_field() }}
