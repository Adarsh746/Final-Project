    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add Doctor</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('franchise.doctor.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="col-md-6">      
                        <select id="place_id"  class="form-control" name="hospital_id" value="{{ old('hospital_id') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('doctor_category') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="doctor_category" type="text" class="form-control" name="doctor_category" value="{{ old('doctor_category') }}" required autofocus>
