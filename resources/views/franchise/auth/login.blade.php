            ...
            <h3 class="form-title font-red">Labourer</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input id="email" type="email" class="form-control form-control-solid placeholder-no-fix" autocomplete="off" placeholder="Email" name="email"  required autofocus>
                ...
                <label class="control-label visible-ie8 visible-ie9">Password</label>
                                <input id="password" type="password" autocomplete="off" placeholder="Password" class="form-control form-control-solid placeholder-no-fix" name="password" required>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('franchise.password.request') }}" id="forget-password" class="forget-password">Forgot Password?</a>
                </div>
