        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <a type="button" href="{{URL::route('franchise.tool.create')}}" class="btn green" >Add New</a>
                        ...
                        @foreach($rent as $value)
                            ...
                            <tr role="row" class="odd">
                               ...
                               <td class="sorting_11"> <img class="dt-img" style="max-height:150px; max-width:150px;" src="/tool/images/{{ $value->tool_image}}"></td>
                                ...
                                <a  href="{{route('franchise.tool.edit',$value->tool_id)}}">
                            ...
                            <td class="text-center">
                                <form method="POST" action="{{route('franchise.tool.destroy',$value->tool_id)}}">
                                    {{ csrf_field() }}
