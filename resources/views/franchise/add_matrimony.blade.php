    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Add Matrimony</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('franchise.matrimony.store') }}">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="number" min="18" max="100"  class="form-control" name="age" value="{{ old('age') }}" required autofocus>
                               @if ($errors->has('age'))                                
                            <span class="help-block">
                        ...
                        <div class="col-md-6">      
                        <select id="religion"  class="form-control" name="religion" value="{{ old('religion') }}" required autofocus>
                        ...
                        <div class="col-md-6">      
                        <select id="caste"  class="form-control caste" name="caste" value="{{ old('caste') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="weight" type="number" min="1" max="500"  class="form-control" name="weight" value="{{ old('weight') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('height') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="height" type="number" min="1" max="500"  class="form-control" name="height" value="{{ old('height') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('mobile_number2') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ddress" type="textarea" class="form-control" name="address" value="{{ old('address') }}" required autofocus>
                        ...
                        @foreach ($users as $user)
                         ...
                         <div class="form-group{{ $errors->has('education') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="education" type="textarea" class="form-control" name="education" value="{{ old('education') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('job') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="job" type="textarea" class="form-control" name="job" value="{{ old('job') }}" required autofocus>
                               @if ($errors->has('job'))                                
                            <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('color') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="color" type="textarea" class="form-control" name="color" value="{{ old('color') }}"  autofocus>
                               @if ($errors->has('color'))                                
                            <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('demands') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="demands" type="textarea" class="form-control" name="address" value="{{ old('demands') }}"  autofocus>
