    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading " style="background:#36c6d3;color:white">Edit Hospital</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('franchise.hospital.change',$hospital->hospital_id) }}">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('hospital_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="hospital_name" type="text" class="form-control" name="hospital_name" value="{{ $hospital->hospital_name }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input  id="description" type="text" class="form-control" name="description" value="{{ $hospital->description }}" required autofocus>   
                  ...
                  <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input  id="Address" type="text" class="form-control" name="address" value="{{ $hospital->address }}" required autofocus >
                            ...
                            <div class="col-md-6">
                                <input id="mobile_number" type="text" class="form-control" name="mobile_number" value="{{ $hospital->mobile_number }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('mobile_number2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_number2" type="text" class="form-control" name="mobile_number2" value="{{ $hospital->mobile_number2 }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('hospital_capacity') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="hospital_capacity" type="text" class="form-control" name="hospital_capacity" value="{{ $hospital->hospital_capacity }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('open_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="open_time" type="time" class="form-control" name="open_time" value="{{ $hospital->open_time }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('close_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="close_time" type="time" class="form-control" name="close_time" value="{{ $hospital->close_time }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="website" type="text" class="form-control" name="website" value="{{ $hospital->website }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="facebook" type="text" class="form-control" name="facebook" value="{{ $hospital->facebook }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('whatsapp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="whatsapp" type="text" class="form-control" name="whatsapp" value="{{ $hospital->whatsapp }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('instagram') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="instagram" type="text" class="form-control" name="instagram" value="{{ $hospital->instagram }}" required autofocus>
                        ...
                        <div class="col-md-6">      
                        <select id="place_id"  class="form-control" name="place_id" value="{{ $hospital->place_id }}" required autofocus>
                        @foreach ($city as $nat)
